...
<body>
          ...
          <ul>
            ...
            <!--li class="dropdown"><a href="#"><span>Projects</span> <i class="bi bi-chevron-right"></i></a>
              <ul>
                ...
                <li><a href="#">Solo (Sumber)</a></li>
                <li><a href="#">Yogyakarta</a></li>
              </ul>
            </li-->
            <li><a href="/proyekjakarta">Jakarta</a></li>
  ...
  <footer id="footer">
    <div class="container">
      <h3>Indira Kader Home Living</h3>
      <p>Professional Classicism Interior Design</p>
      ...
      <div class="credits">
        ...
        Created by <a href="https://instagram.com/astri.fadilah">Astri Fadilah</a>
      </div>
    </div>
  </footer><!-- End Footer -->
